...
from _win_token_popen import PopenWindowsWithToken
...
popen_instance: Optional[PopenWindowsWithToken] = None
...
def run() -> None:
    ...
    user = WindowsSessionUserWithToken(username=username, password=password, load_profile=False)
    ...
    popen_instance = PopenWindowsWithToken(
        user=user,
        **popen_args,
    )
